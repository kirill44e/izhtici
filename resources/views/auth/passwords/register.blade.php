...
<head>
  ...
  <div class="divimg">
    ...
    <form style="width: 35%; margin: auto; text-align: center; margin-top: 10%;" method="POST" action="{{ route('register') }}">
    @csrf
      ...
      @enderror
      <br>
      <button class="w-100 btn btn-lg btn-primary" type="submit" style="font-size: 14px;">Регистрация</button>
      <a href="{{ route('/auth/login')}}" style="font-size: 20px;">Авторизация</a>
    </form>
  </div>
</body>
</html>
